...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, class_ids, ori_img):
        ...
        # Create detections including class IDs
        detections = [Detection(bbox_tlwh[i], confidences[i], features[i], class_ids[i])
        ...
        # Collect outputs from confirmed tracks
        outputs = []
        for track in self.tracker.tracks:
            ...
            class_id = track.class_id  # Correctly access class_id directly from the track
